            ...
            <div className='pageWrapper'>
                <div className='gridBlogTwo'>
                    <div className='gridCol'>
                        <h2 className='secTitle text-align-center'>Click & Collect</h2>
                        ...
                        <form className='searchForm'>
                            <div className='searchBox'>
                                ...
                                <input type="text" placeholder="SE1 0FH, London, England, United Kingdom" />
                            ...
                            <div className='restroGroup'>
                                <div className='colLeft'>
                                    <div className='prdtImg'>
                                        <img src='images/rec_burger.jpg' alt='Food Image' />
                                    </div>
                                </div>
                                <div className='colMid productDes'>
                                    <div className='flexBlockTwo noALign'>
