                ...
                <nav className="site__navigation">
                  ...
                  <div className="add--order cartBtn">
                     ...
                     /> */}
                          ...
                          <a><p className="cartItem">{count}</p><svg width="20" height="20" viewBox="0 0 328.997 329.146"><path id="icons8_shopping_cart_1" d="M57.147,2,1,2.285l.161,32.908,34.065-.161L89.445,165.091l-19.7,31.495C55.95,218.613,72.724,248.872,98.7,248.872H297.113V215.964H98.7c-1.831,0-2.042-.36-1.061-1.928l19.346-30.98H239.878a32.9,32.9,0,0,0,28.762-16.936L327.9,59.393a16.431,16.431,0,0,0-14.366-24.424H70.87Zm42.517,263.33a32.908,32.908,0,1,0,32.908,32.908A32.908,32.908,0,0,0,99.664,265.326Zm164.541,0a32.908,32.908,0,1,0,32.908,32.908A32.908,32.908,0,0,0,264.205,265.326Z" transform="translate(-1.004 -1.996)" fill="#fff"></path></svg> &nbsp;<span>${cartPrice}</span></a>
                        </Link>
                      </div>
                    {isToken != "" ? (
                      <li className="logOut">
